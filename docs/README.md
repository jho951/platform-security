...
| 목적                                         | 문서                                                             |
|--------------------------------------------|----------------------------------------------------------------|
| 3계층이 보안 흐름을 직접 조립하지 않고 2계층을 거치는 이유        | [why-use-platform-security.md](./why-use-platform-security.md) |
| 2계층 platform-security 흐름과 책임 경계 이해              | [architecture.md](./architecture.md)                           |
| 단일 starter와 내부 모듈 기준 확인                    | [modules.md](./modules.md)                                     |
