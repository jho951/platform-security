...
/**
 * platform {@link SecurityRequest}와 auth 1계층의 실제 인증 구현 사이를 잇는
 * 작은 adapter다.
 *
 * <p>구현체는 request attributes를 하위 provider가 기대하는 credential 객체로
 * 변환하는 데 집중한다. 서비스별 user provisioning, tenant mapping, 권한 정책은
 * 넣지 않는다.</p>
 */
